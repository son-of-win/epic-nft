...
export interface ValueChangeEventObject {
  value: BigNumber;
}
export type ValueChangeEvent = TypedEvent<[BigNumber], ValueChangeEventObject>;
...
export interface Box extends BaseContract {
  ...
  filters: {
    "ValueChange(uint256)"(value?: null): ValueChangeEventFilter;
    ValueChange(value?: null): ValueChangeEventFilter;
  };
